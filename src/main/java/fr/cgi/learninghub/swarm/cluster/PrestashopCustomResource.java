...
@Version("v1")
@Kind("Prestashop")
public class PrestashopCustomResource extends CustomResource<BaseDeployment.BaseDeploymentSpec, Void> implements Namespaced {
    ...
    public PrestashopCustomResource(Deployment deployment, DatabaseSecret dbSecret) {
